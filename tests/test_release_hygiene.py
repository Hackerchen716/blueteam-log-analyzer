...
""",
    ...
    def test_release_check_script_and_setup_version_are_safe(self):
        ...
        self.assertIn("windows_json.py", release_check_text)
        self.assertIn("edr_xlsx.py", release_check_text)
        self.assertIn("edr-xlsx", release_check_text)
        self.assertIn("_run_distribution_install_smoke", release_check_text)
        self.assertIn("--no-index", release_check_text)
        self.assertIn("windows-json", release_check_text)
        self.assertIn("winlogbeat_record", release_check_text)
        self.assertIn("auto_parse", release_check_text)
        self.assertIn("winlogbeat-pretty.json", release_check_text)
        self.assertIn("_venv_script", release_check_text)
        self.assertIn("installed-cli-report.json", release_check_text)
        self.assertIn("installed-cli-bundle", release_check_text)
        self.assertIn("installed console script", release_check_text)
        self.assertIn("installed CLI manifest input hash mismatch", release_check_text)
        self.assertIn("installed CLI HTML bundle should not depend on CDN assets", release_check_text)
        self.assertIn("duplicate-basenames-bundle", release_check_text)
        self.assertIn("installed CLI duplicate basename manifest inputs collapsed", release_check_text)
        self.assertIn("host-a/access.log", release_check_text)
        self.assertIn("host-b/access.log", release_check_text)
        self.assertIn("manifest-options-bundle", release_check_text)
        self.assertIn("installed CLI manifest options leaked config path", release_check_text)
        self.assertIn("rules-token=<redacted>", release_check_text)
        self.assertIn("auditpol-tampering", release_check_text)
