...
class ParseStats:
    ...
    windows_process_creation_stats: Dict[str, Any] = field(default_factory=dict)
    web_forensics: Dict[str, Any] = field(default_factory=dict)
    time_start: str = ""
    time_end: str = ""
    parse_errors: int = 0
...
class AnalysisSummary:
    ...
    incident_brief: Dict[str, Any] = field(default_factory=dict)
