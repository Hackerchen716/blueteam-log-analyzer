...
def generate_report_bundle(
    ...
    paths = {
        ...
        "brief": os.path.join(output_dir, "incident_brief.md"),
        "evidence": os.path.join(output_dir, "incident_evidence.csv"),
    ...
    generate_incident_brief_report(parse_results, summary, paths["brief"])
    generate_incident_evidence_csv(parse_results, summary, paths["evidence"])
    generate_manifest(
        parse_results,
        summary,
        paths["manifest"],
