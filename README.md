...
| 方向 | v1.3.8 重点 |
| --- | --- |
| 终端可读性 | 长中文证据、路径和命令行按显示宽度截断，减少拓扑树换行错位 |
...
更多变更见 [v1.3.8 发布说明](https://github.com/Hackerchen716/blueteam-log-analyzer/blob/main/docs/releases/v1.3.8.md)，历史版本见 [docs/releases](https://github.com/Hackerchen716/blueteam-log-analyzer/tree/main/docs/releases)。
